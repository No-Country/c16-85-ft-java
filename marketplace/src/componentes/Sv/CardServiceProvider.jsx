    ...
    >
      ...
      <dl className="mt-6 flex gap-4 sm:gap-6 justify-center sm:justify-start">
        <div className="flex flex-col-reverse">
          ...
          <Link to="/Detalle" className="inline-flex items-center justify-center w-full px-6 mb-3 font-medium tracking-wide transition duration-200 rounded shadow-md md:w-auto md:mb-0 focus:shadow-outline focus:outline-none bg-slate-600 text-stone-50 py-2 border hover:text-green-600">
