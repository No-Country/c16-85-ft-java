...
const Service = () => {
  ...
  const serviceDetails = [{
    name: 'Electricista', description: '¡Soluciones eléctricas confiables al alcance de tu mano! Nuestro equipo de electricistas expertos ofrece servicios de instalación, reparación y mantenimiento eléctrico para hogares, negocios y proyectos industriales. '
    , img: imgElectrician
  },
  {
